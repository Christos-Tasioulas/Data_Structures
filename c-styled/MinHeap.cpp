...
void MinHeap::HeapInsert(void* value, int (*compare)(void *, void *))
{
...
void MinHeap::RemoveMin(int (*compare)(void *, void *))
{
...
void MinHeap::heapify_up(BinaryTreeNode* node, int (*compare)(void *, void *))
{
...
void MinHeap::heapify_down(BinaryTreeNode* node, int (*compare)(void *, void *))
{
