...
#
# Το override επιτρέπει την προσθήκη επιπλέον παραμέτρων από τη γραμμή εντολών: make CPPFLAGS=...
#
override CPPFLAGS += -g -Wall -Werror -MMD -I$(INCLUDE)
